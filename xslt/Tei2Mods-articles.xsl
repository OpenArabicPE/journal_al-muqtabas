...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:output method="xml" encoding="UTF-8" indent="yes" omit-xml-declaration="no" name="xml" version="1.0"
    ...
    <xsl:template
        ...
        <xsl:result-document href="../metadata/{concat($vFileId,'-',@xml:id)}.MODS.xml" method="xml">
